...
• Consumer_Shopping_Behaviour_Project_Report.docx — Detailed project report covering methodology, all SQL outputs, findings, and recommendations
• Consumer_Shopping_Behaviour_Analytics.pptx — Presentation deck 
